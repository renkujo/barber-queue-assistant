...
export const OwnerClosedQueueList = ({ queue }: { queue: QueueListItem[] }) => {
  ...
  return (
    <Card className="bqa-owner-closed-list" aria-labelledby="owner-closed-title">
      <CardHeader className="bqa-owner-closed-heading">
        <CardTitle id="owner-closed-title">ปิดแล้ววันนี้</CardTitle>
        <CardDescription>{queue.length} คิว</CardDescription>
      </CardHeader>

      <CardContent className="bqa-owner-closed-content">
